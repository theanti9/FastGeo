"""
The FastGeo module is meant to provide very fast lookups for country GeoIP information.
"""
...
class MaxMindGeoLiteCSVParser(object):
	"""
...
class GeoDB(object):
	...
	"""
	def __init__(self, csvfile, parser=MaxMindGeoLiteCSVParser()):
